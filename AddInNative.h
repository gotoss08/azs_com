...
public:
    enum Props
    {
		...
		ePropCommand,
		ePropAnswer,
		ePropAnswerRaw, // ERP Pereverzev 16.10.2021
		ePropError,
		ePropLoging,
    ...
    enum Methods
    {
        ...
        eMethClose,
        eMethSend,
		eMethSendRaw, // ERP Pereverzev 16.10.2021
        eMethRecieve,
		eMethRecieveRaw, // ERP Pereverzev 16.10.2021
		eMethDelay,
        eMethSendIKS,
        eMethToHex,
		eMethStartTimer,
	...
	std::wstring		m_ans;
	std::string			m_ans_str; // ERP Pereverzev 16.10.2021
...
private:
	...
	bool string_to_param_raw(std::string s, tVariant* val); // ERP Pereverzev 16.10.2021
	...
	std::wstring		m_cmd;
	std::string			m_cmd_str; // ERP Pereverzev 16.10.2021
//	std::wstring		m_ans;
